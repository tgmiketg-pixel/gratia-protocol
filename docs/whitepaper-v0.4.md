...
## Conceptual Whitepaper v0.4 — DRAFT
...
- Publish formal whitepaper with complete technical specifications
- Develop and open-source the Proof of Life algorithm
- Build shared Rust core library (protocol, wallet, ZK proofs, networking)
- Build proof-of-concept Android app using Kotlin sensor layer + Rust core (10-50 test devices)
- Demonstrate Proof of Life collection and Mining Mode activation on real phones
- Demonstrate consensus over cellular/Wi-Fi network with real sensor attestations
- Begin security review of attestation stack

### Phase 2 — Testnet (Months 7-12)
- Launch public testnet on Android
- Build iOS app using Swift sensor layer + same shared Rust core (UniFFI Swift bindings)
- Release GratiaScript SDK and developer documentation
- Deploy initial smart contract templates (location-triggered, proximity, presence)
- Community testing program (1,000-10,000 nodes across Android and iOS)
- Staking mechanism and overflow pool implementation

### Phase 3 — Mainnet Beta (Months 13-18)
- Mainnet launch with core features (mining, transactions, basic smart contracts)
- Android and iOS apps in respective app stores
- NFC tap-to-pay functionality live
- Geographic reward weighting active
- Governance system active
- Bug bounty program
- Security audit of core protocol and cryptographic mechanisms

### Phase 4 — Full Launch (Months 19-24)
- Full smart contract platform (GratiaVM) live
- Oracle layer (environmental sensor data) operational
- Bluetooth/Wi-Fi Direct mesh layer deployed
- Developer ecosystem grants program
- Partnership development (carriers, device manufacturers, NGOs)

### Phase 5 — Scale (Year 3+)
- Target: 1 million active mining nodes
- Cross-chain bridges to Bitcoin and Ethereum ecosystems
- Enterprise and government partnerships for environmental data
- Localized deployment in key unbanked regions
...
*This document is a conceptual draft (v0.4) and does not constitute a final technical specification. All parameters, thresholds, and mechanisms described herein are subject to revision based on ongoing research, security analysis, and community input.*
